...
def SD_900_Mercator_Check_Software(cluster_id, controller, data, index):
    ...
    succes_tally += match("mercator.redis.status", controller.execute_command("mercator.redis.install", "5.0.9"), 
                          "{}".format(b'OK, Software installation started, use the mercator.redis.status command to verify the installation.'))
  
    succes_tally += match("mercator.redis.status", controller.execute_command("mercator.redis.install", "6.0.1"), 
                          "{}".format(b'OK, Software installation started, use the mercator.redis.status command to verify the installation.'))
    
    succes_tally += match("mercator.redis.status", controller.execute_command("mercator.redis.install", "6.2.0"), 
                          "{}".format(b'OK, Software installation started, use the mercator.redis.status command to verify the installation.'))
  
    succes_tally += match("mercator.redis.status", controller.execute_command("mercator.redis.install", "7.0.1"), 
                          "{}".format(b'OK, Software installation started, use the mercator.redis.status command to verify the installation.'))
  
    succes_tally += match("mercator.redis.status", controller.execute_command("mercator.redis.install", "7.0.14"), 
                          "{}".format(b'OK, Software installation started, use the mercator.redis.status command to verify the installation.'))
    
    succes_tally += match("mercator.redis.status", controller.execute_command("mercator.redis.install", "7.2.3"), 
                          "{}".format(b'OK, Software installation started, use the mercator.redis.status command to verify the installation.'))
    
    succes_tally += match("mercator.redis.status", controller.execute_command("mercator.redis.install", "beta-9"), 
                          "{}".format(b'OK, Software installation started, use the mercator.redis.status command to verify the installation.'))
